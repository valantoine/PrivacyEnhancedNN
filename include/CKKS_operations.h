...
extern ciphered_t *ckks_mult_cipher_cipher(ciphered_t *c1, ciphered_t *c2, mpz_t modulo,  ciphered_t *evk_g_precomputed, mpz_t g);

extern ciphered_t *evk_g(polynomial_t *secret_key, mpz_t current_modulo, mpz_t g);

// extern mpz_t random_power_of_2_below(mpz_t A);
