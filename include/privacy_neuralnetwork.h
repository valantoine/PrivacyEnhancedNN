...
#define PRECISION_VALUE 2048
#define SCALING_FACTOR_BIT_SIZE 20
#define MODULO_0_BIT_SIZE 150  //Must be way bigger than scaling_factor_size
...
extern ciphered_matrix_t *encrypt_image(image_t image, polynomial_t *secret_key, mpz_t precision_factor, mpz_t scaling_factor, mpz_t modulo_full, gmp_randstate_t state);

extern uint8_t decrypt_prediction(ciphered_matrix_t *c, polynomial_t *secret_key, mpz_t precision_factor, mpz_t scaling_factor, mpz_t modulo_0);
...
extern uint8_t *predict_image_private(dataset_t *test_dataset, const nn_parameters_t *parameters, polynomial_t *secret_key, gmp_randstate_t state);
